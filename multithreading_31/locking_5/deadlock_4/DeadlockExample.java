...
class Task2 implements Runnable {
    ...
    public void run() {
        synchronized (pen){
            paper.writeWithPaperAndPen(pen); // thread2 locks paper and tries to lock pen //-> this is how we resolved deadlocak condition
        }
        // condition before resolving ->paper.writeWithPaperAndPen(pen); this only not   synchronized (pen){ }
    }
}
